      ...
      <v-row wrap>
        <v-col grow class="py-1 elevation-2">
          ...
          <v-tabs-items v-model="tab" grow class="pa-4">
                ...
                <v-card-text>
                  ...
                  <v-row class="mb-5 pb-2" align-center>
                    ...
                    <v-col
                      ...
                      class="text-left text--primary subtitle-1 py-0"
                    >
                      <v-btn @click="seeInputFile()" text color="primary"
                        >See input dataset</v-btn
                      >
                    </v-col>
                  </v-row>
                  <v-row class="mb-5 pb-2" align-center>
            ...
            <v-tab-item>
              <v-card
                v-if="this.project.converted == false"
                class="mx-auto"
                max-width="500"
              >
                <v-card-text>
                  <p class="text-center font-weight-bold red--text">
                    The input Dataset is not converted yet !
                  </p>
                </v-card-text>
              </v-card>
              <v-card
                v-if="this.project.converted == true"
                class="mx-auto"
                max-width="500"
              >
                <v-card-text>
                  <p class="headline text--primary">
                    Linked Data Output file :
                  </p>
                  <h4><v-icon>mdi-file</v-icon>fileRDF</h4>
                  <v-divider></v-divider>
